...
extension AppDelegate{
    ...
    func setRootViewController(){
        ...
        let MovieNV = RTRootNavigationController.init(rootViewController: LVMovieViewController())
        MovieNV.tabBarItem.image = UIImage(named: "tab_movie")?.withRenderingMode(.alwaysOriginal)
        MovieNV.tabBarItem.selectedImage = UIImage(named: "tab_movie_select")?.withRenderingMode(.alwaysOriginal)
        MovieNV.tabBarItem.setTitleTextAttributes([NSAttributedString.Key.foregroundColor:UIColor(hexString: "#41BEFE")!], for: .selected)
        MovieNV.tabBarItem.title = "电影"
        
        let episodeNV = RTRootNavigationController.init(rootViewController: LVEpisodeViewController())
        episodeNV.tabBarItem.image = UIImage(named: "tab_episode")?.withRenderingMode(.alwaysOriginal)
        episodeNV.tabBarItem.selectedImage = UIImage(named: "tab_episode_select")?.withRenderingMode(.alwaysOriginal)
        episodeNV.tabBarItem.setTitleTextAttributes([NSAttributedString.Key.foregroundColor:UIColor(hexString: "#41BEFE")!], for: .selected)
        episodeNV.tabBarItem.title = "剧集"
        ...
        tabBarController.viewControllers = [HomeNV, MovieNV ,episodeNV, MineNV]
    ...
    func setUPLaunchAD(){
        ...
        LVADUtil.loadADData { (response) in
            ...
            imageAdconfiguration.skipButtonType = .time
