//
//  LVHomeEpisodeCollectionViewCell.swift
//  LeavesVideo
//
...
class LVHomeEpisodeCollectionViewCell: UICollectionViewCell {
    ...
    private lazy var totalCountLable: UILabel = {
        let lab = UILabel.init()
    ...
    private func addViews(){
        ...
        self.coverImageView.addSubview(self.totalCountLable)
        ...
        self.totalCountLable.snp.makeConstraints{(make) in
