...
extern NSString * _Nonnull const kDownloadTaskFinishedNoti;
...
- (void)downloadItem:(nonnull YCDownloadItem *)item speed:(NSUInteger)speed speedDesc:(NSString *_Nonnull)speedDesc;
@end
